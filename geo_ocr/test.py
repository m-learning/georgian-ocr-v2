...
def init_arguments():
    ...
    parser.add_argument('--height',
                        ...
                        help='image width (64 is default)', default=64)
    parser.add_argument('-s', '--save_path', metavar='save_path',
...
if __name__ == '__main__':
    ...
    for word in args.text:
        img = ig.paint_text(word.decode('utf-8'),
                            args.width, args.height, rotate=True, ud=True,
                            multi_fonts=True, multi_sizes=True, save=False)
