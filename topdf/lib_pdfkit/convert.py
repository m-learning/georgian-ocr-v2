...
image = 'mnatobi.png'
image = 'image001.jpg'
image = 'mnatobi-lines.png'
image = sys.argv[1]

with open('/tmp/test.json', 'r') as f: data = json.load(f)
#font-size: calc(100%% - -1.2em);
css = '<style type="text/css">'
css += "body{background-image: url('./%s');background-repeat: no-repeat; margin:0px; padding: 0px;}" % (image,)
...
pdfkit.from_string(body, '/tmp/export.pdf')
